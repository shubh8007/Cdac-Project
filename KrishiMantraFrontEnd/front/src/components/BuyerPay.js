                        ...
                        <form >
                            ...
                            <div>
                                ...
                                <div className="d-flex align-items-center justify-content-between card-atm border rounded">
                                    <div className="fab fa-cc-visa ps-3"></div> <input type="text" className="form-control" placeholder="Card Details" required/>
                                    <div className="d-flex w-50"> <input type="text" className="form-control px-0" placeholder="MM/YY" required/> <input type="password" maxlength="3" className="form-control px-0" placeholder="CVV" required /> </div>
                                </div>
                                ...
                                <div className="address">
                                    ...
                                    <div className="d-flex flex-column dis">
                                        ...
                                        {/* <div className="btn btn-primary mt-2">Pay<span className="fas fa-dollar-sign px-1"></span>{payment} </div> */}
                                    </div>
                                </div>
                            </div>
                        </form>
