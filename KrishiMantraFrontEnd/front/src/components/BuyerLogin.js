...
function BuyerLogin()
{
    ...
    var onSubmit = (e)=>{
        ...
        axios
    .post("http://localhost:8080/buyer/login", login)
    .then((response) => {
                        ...
                        <div className="col-md-4 offset-md-4 " >
                            <div className="login-form bg-light mt-4 p-4 " >
                                ...
                                <div className="col-12">
                                    <p className="text-center mb-0">New User,please Register? <a href="/Buyer-reg">Signup</a></p>
                                    <p className="text-center mb-0"><a href="/">Forgote password?</a></p>
                                </div>
                            </div>
                        </div>
                    </div>
