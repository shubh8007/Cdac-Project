...
function FarmerPersonalDetails(props) {
    ...
    const url = "http://localhost:8080/farmer/" + username;
    useEffect(() => {
        axios
            .get(url, {})
            .then((response) => {
    ...
    function handleFarmer(){
            ...
            const removeurl = "http://localhost:8080/farmer/delete/" + username;
            axios
                .delete(removeurl, {})
                .then((response) => {
                                    ...
                                    <div class="card-body d-flex justify-content-center col-8">
                                        ...
                                        <div class="card-text col-12">
                                            ...
                                            <center className="d-flex justify-content-evenly">
                                                <button type="button" class="btn btn-success" onClick={handleFarmer}>Susspend Farmer</button>
