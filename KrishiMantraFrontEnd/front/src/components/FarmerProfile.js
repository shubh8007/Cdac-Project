...
function FarmerProfile()
{
    ...
    console.log(changeInfo);
        function changeProfile(){
            ...
            const url = "http://localhost:8080/change-profile/"+sessionStorage.getItem('userType')+"/"+sessionStorage.getItem('authenticatedUser')
              axios
              .post(url, {
    ...
    const url = "http://localhost:8080/farmer/"+sessionStorage.getItem('authenticatedUser');
    useEffect(() => {      
        axios
        .get(url)
        .then((response) => {
