 package com.KrshiMantra.jwtUtils;
...
import com.KrshiMantra.backend.service.CustomUserDetails;
import com.KrshiMantra.backend.service.CustomUserDetailsBuyer;
...
//		log.info("generate jwt token " + authentication);
		CustomUserDetailsBuyer userPrincipal = (CustomUserDetailsBuyer) authentication.getPrincipal();
...
//			log.error("Invalid JWT : " + e.getMessage());
	...
	public String generateJwtToken(Buyer user) {
