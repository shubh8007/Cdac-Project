...
//
//@Service
//public class DaoBasedUserDetailsServiceBuyer implements UserDetailsService {
//	@Autowired
//	private BuyerRepo userRepo;
//
//	/*
...
//		Optional<Buyer> optional = userRepo.getBuyer(userName);
//		Buyer user = optional
//				.orElseThrow(() -> new UsernameNotFoundException("User With Email  " +userName + " not found!!!"));
//		return new CustomUserDetailsBuyer(user);
//	}
//
//}
